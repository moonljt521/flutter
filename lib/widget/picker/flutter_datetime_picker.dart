...
import 'package:flutter_first_demo/widget/picker/date_model.dart';
        ...
        children: <Widget>[
          Container(
            ...
            child: CupertinoButton(
              ...
              child: Text(
                '$cancel',
                style: TextStyle(fontSize: 17,color: const Color(0xFF4A5060),decoration: TextDecoration.none),
              ),
          ...
          Container(
            ...
            child: CupertinoButton(
              ...
              child: Text(
                '$done',
                style: TextStyle(fontSize: 17,color: const Color(0xFFF95862),decoration: TextDecoration.none)
              ),
              onPressed: () {
